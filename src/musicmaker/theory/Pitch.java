...
public class Pitch {
   ...
   public static final int MIDDLE_C_OFFSET = 61;
   public static final String SUPPORTED_RANGE_STRING = "C-1 to G9";
   ...
   public static float findFreq(Note note, int octave) {
      ...
      int val = (note.getValue() - 3) + (octave * 12 - 48);
      val += MIDDLE_C_OFFSET;
   ...
   public static void main(String[] args) {
      ...
      if (args[1].matches("-?[0-9]+")) {
         ...
         WavetableSynth synth = maxim.createWavetableSynth(514);
